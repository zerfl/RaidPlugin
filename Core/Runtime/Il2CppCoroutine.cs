...
namespace RaidPlugin
{
    public static class Il2CppCoroutine
    {
        ...
        private static void ProcessNextOfCoroutine(IEnumerator enumerator)
        {
            ...
            {
                Bootstrapper.LogError(e.ToString());
            ...
            switch (next)
            {
                ...
                case Il2CppObjectBase il2CppObjectBase:
                    ...
                    if (nextAsEnumerator != null) // il2cpp IEnumerator also handles CustomYieldInstruction
                        ...
                        Bootstrapper.LogWarning($"Unknown coroutine yield object of type '{il2CppObjectBase}' for coroutine '{enumerator}'");
                    return;
                default:
	                Bootstrapper.LogWarning($"Unknown coroutine yield object of type '{next}' for coroutine '{enumerator}'");
                    return;
            }
